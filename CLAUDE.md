...
Articles are published **one per week, every Tuesday at 08:03 CET**, starting from 16 December 2025. Two GitHub Actions cron run on Tuesday at 05:47 UTC and 06:47 UTC (≈ 07:47 / 08:47 CEST in summer, 06:47 / 07:47 CET in winter): the first publishes the article, the second is backup in case the first is delayed by GitHub Actions queue (common during peak hours like `:00`/`:05`). The article is online well before the LinkedIn post goes out (scheduled on Buffer at ~10:05–10:15 CET).
