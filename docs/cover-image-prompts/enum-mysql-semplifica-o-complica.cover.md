...
Un ufficio mid-century ordinato, luce diurna soffusa proveniente da una finestra laterale. Il DBA con baffi a manubrio brizzolati è in piedi davanti a una grande lavagna stilizzata. Sulla lavagna, tre colonne geometriche affiancate — ciascuna con un'etichetta breve in inglese: "ENUM", "CHECK", "LOOKUP" — collegate da frecce eleganti a un cilindro-database centrale disegnato in primo piano. La colonna "ENUM" ha accanto una piccola catena stilizzata (vincolo), la colonna "LOOKUP" mostra una pila di rettangoli sovrapposti (righe di tabella). Il personaggio indica con una mano la colonna centrale, espressione concentrata e leggermente ironica. In secondo piano, silhouette di scaffali con raccoglitori d'archivio per suggerire contesto senza affollare. Mood professionale, atmosfera da jazz club vintage, ombre proiettate nette.