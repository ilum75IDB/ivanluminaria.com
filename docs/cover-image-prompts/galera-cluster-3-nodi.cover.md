...
Un ufficio mid-century elegante, luce diurna soffusa. Il DBA con baffi a manubrio brizzolati è in piedi davanti a una grande lavagna stilizzata, giacca scura, espressione sicura e leggermente ironica. Sulla lavagna: tre cilindri-database geometrici disposti a triangolo, collegati da frecce bidirezionali pulite che suggeriscono replica sincrona. Un singolo cilindro è evidenziato in rosso — fuori dal triangolo, isolato — con una croce stilizzata sopra: il nodo caduto. Gli altri due rimangono connessi e operativi. In primo piano, una scrivania con un monitor a tubo d'epoca che mostra il numero "3" in grande, leggibile. Atmosfera da poster aziendale anni '50, composizione triangolare, mood di controllo tecnico composto.
