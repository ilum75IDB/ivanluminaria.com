...
Un ufficio mid-century elegante, luce diurna soffusa. Il DBA con baffi a manubrio brizzolati è seduto alla scrivania, giacca scura, espressione concentrata e leggermente ironica, con davanti a sé un grande foglio aperto — un runbook stilizzato con colonne di passi numerati e frecce geometriche. Sulla scrivania, un telefono nero d'epoca e una tazza da caffè. Sullo sfondo, una grande lavagna stilizzata divisa in due colonne: a sinistra due cilindri-database sovrapposti etichettati "ON-PREM", a destra una nuvola geometrica stilizzata con un cilindro-database etichettata "CLOUD", collegati da una freccia orizzontale rossa e decisa che attraversa il centro della lavagna. In primo piano, sul bordo della scrivania, un foglio con una tabella a due colonne — simbolo del confronto costi — con alcune voci sottolineate in rosso. Mood professionale, atmosfera da sala operativa silenziosa la notte prima del grande spostamento.
