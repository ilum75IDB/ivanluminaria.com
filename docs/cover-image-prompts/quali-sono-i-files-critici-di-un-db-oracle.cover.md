...
Telefonata notturna ricevuta: Ivan — baffi a manubrio brizzolati, vestaglia di seta scura su pigiama elegante anni '50 — seduto in poltrona di pelle in una stanza in penombra profonda, cornetta di un telefono nero d'epoca premuta all'orecchio, espressione concentrata e già lucida nonostante l'ora. Una sola lampada da tavolo Art Deco illumina la scena dal basso-sinistra, proiettando ombre lunghe e nette. Sul piano laterale della poltrona, un foglio con tre simboli geometrici disposti in sequenza verticale: un cilindro stilizzato (parameter file), un rombo (control file), un nastro circolare (redo log) — la triade critica del database. Sullo sfondo, silhouette di un orologio a parete che segna le 3:08. Mood notturno, tensione composta, nessun elemento moderno.