...
Un ufficio mid-century in penombra serale, illuminato dalla luce calda e radente di una lampada da tavolo Art Deco. Il personaggio principale — baffi a manubrio brizzolati, giacca elegante scura, espressione concentrata e leggermente ironica — è seduto alla scrivania con un telefono nero d'epoca nell'orecchio. Davanti a lui, su un grande monitor stilizzato a tubo catodico, due pannelli geometrici affiancati: a sinistra una griglia di barre orizzontali che rappresenta un grafico AWR (etichetta "AWR" in alto), a destra una sequenza verticale di linee-campione ravvicinate che evoca il campionamento secondo per secondo di ASH (etichetta "ASH"). Al centro della scrivania, un foglio con un semplice diagramma a freccia che collega due cilindri-database stilizzati, uno con una croce rossa (indice mancante) e uno con una spunta (indice ripristinato). Sullo sfondo, silhouette di finestre con luce serale che declina. Mood: tensione composta, diagnosi in corso, soluzione a portata di mano.
