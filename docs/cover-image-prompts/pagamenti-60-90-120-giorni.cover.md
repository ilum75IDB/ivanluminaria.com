...
Un ufficio professionale mid-century in piena luce diurna. Il personaggio principale — baffi a manubrio brizzolati, giacca elegante scura — è seduto alla scrivania e osserva con espressione ironica e composta un grande calendario da parete stilizzato, sul quale una sequenza di frecce geometriche rosse scorre da un mese al successivo, indicando un arco lungo: 30, 60, 90, 120 giorni marcati come tacche su una linea orizzontale che taglia il calendario. Sul piano della scrivania, una busta aperta con una fattura stilizzata e una bilancia a due piatti: su un piatto un simbolo di lavoro completato (una cartella chiusa, stilizzata), sull'altro un simbolo monetario che pende ancora vuoto. Sullo sfondo, una finestra con luce naturale e la silhouette geometrica di edifici urbani anni '50. Mood composto, leggermente sardonico — la tensione è quella di chi conosce bene il gioco e lo osserva dall'esterno senza più sorprendersi.
