...
Un ufficio mid-century ordinato, luce diurna soffusa. Il DBA con baffi a manubrio brizzolati è seduto alla scrivania in giacca scura, espressione concentrata e leggermente ironica. Davanti a lui, su una grande lavagna stilizzata in primo piano, tre etichette geometriche disposte verticalmente — ciascuna con la forma di un cartellino d'identità — recano le scritte "mario @ localhost", "mario @ 192.168.1.20", "mario @ %" a indicare che lo stesso nome corrisponde a identità distinte. Frecce eleganti collegano ciascun cartellino a un piccolo cilindro-database sul lato destro della lavagna, con tratti di spessore diverso a suggerire privilegi differenziati. Il personaggio indica la lavagna con una matita, sguardo che trasmette la precisione del punto tecnico. Nessun altro personaggio in scena. Atmosfera da jazz club vintage, ombre proiettate nette, texture di carta visibile.