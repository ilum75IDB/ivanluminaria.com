...
Un ufficio mid-century elegante e ordinato. Al centro, il DBA con baffi a manubrio brizzolati in giacca scura è in piedi davanti a una grande lavagna stilizzata. Sulla lavagna, una sequenza verticale di forme geometriche — quattro rettangoli arrotondati impilati, etichettati "ACTIVE", "SUSPENDED", "TERMINATED", "EXPIRED" — con frecce che ne indicano le relazioni. Una delle forme è cerchiata in rosso e attraversata da una riga diagonale, a simboleggiare il valore da ritirare. Accanto, sul piano medio, un cilindro-database stilizzato con una freccia che punta verso una piccola tabella di lookup separata, suggerendo la migrazione verso un pattern alternativo. Espressione del personaggio: attenta, leggermente ironica, come chi sta valutando due strade e sa già quale costerà di più. Sfondo semplice con texture di carta, illuminazione diurna soffusa da una finestra geometrica fuori campo. Mood da ufficio tecnico anni '50, nessun affollamento.