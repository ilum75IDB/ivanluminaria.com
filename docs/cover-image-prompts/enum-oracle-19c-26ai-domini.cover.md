...
Un ufficio elegante anni '50 in luce diurna soffusa. Il personaggio principale — DBA con baffi a manubrio brizzolati, giacca scura — è in piedi davanti a una grande lavagna stilizzata. Sulla lavagna, una sequenza orizzontale di quattro riquadri geometrici disposti come tappe di una linea del tempo: etichettati "19c", "21c", "23ai", "26ai". I primi due riquadri mostrano simboli semplici (una freccia piatta, un cerchio vuoto — stasi), il terzo riquadro è il più grande e luminoso, con al centro un cilindro-database stilizzato da cui si diramano frecce verso più tabelle geometriche collegate — simbolo del Domain riusabile. Il quarto riquadro mostra due tabelle distinte unite da un arco tratteggiato, simbolo del vincolo cross-tabella. Il personaggio indica con la mano aperta il terzo riquadro, espressione sicura e leggermente ironica. Sullo sfondo, silhouette di scaffalature con raccoglitori d'archivio. Atmosfera da jazz club vintage, ombre proiettate nette, texture di carta ruvida visibile.
