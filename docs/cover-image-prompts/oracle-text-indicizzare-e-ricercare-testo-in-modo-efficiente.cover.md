...
Un ufficio legale elegante in stile mid-century, luce diurna soffusa proveniente da una finestra laterale. In primo piano, il DBA con baffi a manubrio brizzolati — Ivan — è seduto a una scrivania ordinata di fronte a un secondo personaggio: un uomo più giovane, senza baffi, capelli lisci, giacca formale, espressione tesa ma attenta (Alberto, il cliente). Tra i due, al centro della scrivania, una grande lavagna stilizzata su cui sono disegnati tre cilindri-database geometrici, ciascuno collegato a un simbolo diverso: una freccia libera (testo non strutturato), una griglia (attributi strutturati), un albero gerarchico (documenti XML). Ivan indica uno dei cilindri con espressione concentrata e leggermente ironica, come chi sta spiegando qualcosa che era già lì, in attesa di essere usato. Sullo sfondo, scaffali di archivio stilizzati con fascicoli impilati, a evocare decenni di documenti sedimentati. Mood professionale, conversazionale, atmosfera da studio legale anni '50.