...
Una strada urbana stilizzata divisa verticalmente in due metà speculari, come la copertina di un libro mid-century. A sinistra: una grande berlina anni '50 ferma in una colonna di traffico immobile, ombre dense, clacson geometrici stilizzati che si sovrappongono come onde concentriche, un orologio sul cruscotto che segna un'ora tarda — il conducente con baffi a manubrio brizzolati visibile di profilo, spalle tese, espressione rassegnata. A destra: lo stesso personaggio — ora rilassato, in sella a una bicicletta pieghevole compatta e geometrica — che scorre libero lungo una corsia ciclabile vuota, vento stilizzato tra i capelli, posa aperta e leggera. Sullo sfondo di entrambe le metà, la silhouette semplificata di una cupola romana e di un lungotevere. In basso al centro, tra le due scene, una bilancia stilizzata Art Deco con due piatti: a sinistra un simbolo monetario pesante (monete geometriche impilate), a destra un orologio con lancette che indicano tempo libero. Illuminazione soffusa, texture di carta ruvida, palette rigorosa nero-beige-rosso-marrone.
