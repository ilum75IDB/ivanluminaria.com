...
Un ufficio elegante mid-century in luce diurna. Il DBA con baffi a manubrio brizzolati è in piedi davanti a una grande lavagna stilizzata, giacca scura, espressione concentrata e leggermente ironica. Sulla lavagna: tre catene di frecce geometriche che convergono verso un unico grande lucchetto stilizzato — simbolo visivo del vincolo dichiarativo che sostituisce i tre trigger. A sinistra della lavagna, in secondo piano, due cilindri-database sovrapposti collegati da una freccia verticale (le tabelle `polizze` e `beneficiari`). Il personaggio indica con una mano aperta il lucchetto centrale, come a sottolineare che il punto è lì — nello schema, non nel codice. Nessun testo. Atmosfera da poster corporate anni '50, illuminazione soffusa da finestra laterale, texture di carta ruvida visibile su tutta la superficie.