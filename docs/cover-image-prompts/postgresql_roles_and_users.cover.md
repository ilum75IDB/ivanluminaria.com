...
Un ufficio mid-century elegante, luce diurna soffusa. Il DBA con baffi a manubrio brizzolati è in piedi davanti a una grande lavagna stilizzata, espressione leggermente ironica. Sulla lavagna: un unico grande cerchio geometrico etichettato "ROLE" da cui si diramano due frecce nette verso due forme distinte — una con il simbolo di un lucchetto aperto (LOGIN) e una con un fascio di frecce sovrapposte (permissions). In primo piano sulla scrivania, un foglio con una gerarchia ad albero stilizzata: un nodo radice che si ramifica verso nodi figli, a suggerire l'ereditarietà dei privilegi. Nessun secondo personaggio: scena a figura singola, mood riflessivo e didattico.
