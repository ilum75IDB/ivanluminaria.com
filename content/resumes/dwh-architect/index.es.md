...
Batch analíticos de 4 horas a menos de 30 minutos en Oracle OCI y Autonomous Database — sin cambio de hardware, solo trabajando en diseño y planes de ejecución. Atradius Surety: DWH sobre 4 países EU, 60.000+ líneas de PL/SQL, carga daily por debajo de 2 horas. GENERALI: DWH asegurador 500 GB–8 TB. TIM (vía Huawei): 30+ Oracle en Exadata, 800M registros/día, SLA por debajo de 500 ms. Migración ODI 10g→12c para Allianz y Mediobanca — nunca desde cero, siempre en continuidad. Kimball, Inmon, star/snowflake, SCD, bus matrix. Docencia Oracle Italia sobre SQL, PL/SQL, tuning. Lo que aporto: una segunda opinión independiente antes de que firmes un presupuesto de cientos de miles de euros, un método que parte de los datos que el sistema ya registra (AWR, ASH, wait events, planes de ejecución), y la disciplina de decir "tu sistema actual todavía puede aguantar — te explico cómo".
