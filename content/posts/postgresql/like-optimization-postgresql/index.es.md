...
La extensión `pg_trgm` habilita la búsqueda por trigramas [1], usada junto con un índice `GIN` [2]; el modo `CONCURRENTLY` permite añadir el índice sin bloquear INSERT/UPDATE/DELETE sobre la tabla [3].
