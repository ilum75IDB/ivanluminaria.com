...
Si un PM reconoce solo los resultados, cuando los resultados se retrasan por causas externas las personas se desmotivan. Han trabajado bien, en algunos casos incluso mucho, y oyen decir *"igualmente el go-live se ha caído"*. La próxima vez trabajarán menos, porque han aprendido que su esfuerzo no cuenta si el outcome externo no llega. El término técnico es la distinción entre {{< glossary term="outcome-vs-output" >}}outcome y output{{< /glossary >}}: el output es lo que el equipo ha producido, el outcome es el resultado final medido por el negocio.
