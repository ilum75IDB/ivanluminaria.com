...
| Métrica | Qué dice |
|---|---|
| **Velocity** | Cuánto entrega el equipo por sprint |
| **Lead time** | Cuánto pasa desde la solicitud hasta el lanzamiento |
| **Bug escape rate** | Cuántos defectos se escapan a producción |
| **Sprint goal success** | % de objetivos de sprint logrados |
| **Team happiness** | Cómo se siente el equipo — la métrica más importante |
