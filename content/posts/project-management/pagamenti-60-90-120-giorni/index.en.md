...
seoTitle: "Payment terms 60-90-120 days: Italy vs Europe"
description: "60-90-120 day payment terms in Italian IT consulting: comparison with European rules. DSO, EU directive 2011/7 and strategies for IT freelancers."
...
1. You work in October.
2. You invoice at the end of October.
3. The invoice enters the client's administrative cycle in November.
4. The client pays at "60 days end of month" — which in practice means the end of January.
5. If things go well. If there's no year-end payment freeze. If the administration office hasn't "lost" the invoice. If the manager has signed the approval.
...
**[DSO](/en/glossary/dso/)** — Days Sales Outstanding — average number of days a company takes to collect its receivables. In Italy the average is 80 days, nearly three times the European average.

**[Financial Float](/en/glossary/float-finanziario/)** — Zero-cost liquidity generated by the difference between collection times from clients and payment times to suppliers.

**[Late Payment Interest](/en/glossary/interessi-di-mora/)** — Automatic interest prescribed by law (ECB rate + 8%) accruing on every invoice paid late, without the need for formal notice.

**[Partita IVA](/en/glossary/partita-iva/)** — Italian tax regime for self-employed workers and freelancers, which in IT consulting implies directly bearing the credit risk toward clients.

**[Directive 2011/7/EU](/en/glossary/direttiva-2011-7-ue/)** — European directive on late payments setting the standard term at 30 days, maximum at 60, and providing automatic late interest.
