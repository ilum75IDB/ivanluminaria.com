...
description: "Ivan Luminaria: 30 ani de experiență ca DBA Oracle, PostgreSQL și DWH Architect. Specialist în performance tuning, înaltă disponibilitate și securitate DB."
date: "2026-02-20"
lastmod: "2026-02-26"
draft: false
layout: "about"
...
{{< about-section-card icon="🔧" title="Cum lucrez" >}}
...
{{< about-section-card icon="🎯" title="Viziune" >}}
...
{{< about-section-card icon="🎨" title="Dincolo de muncă" >}}
...
{{< about-passion-grid >}}
{{< about-passion-pill icon="📷" name="Fotografie" >}}
{{< about-passion-pill icon="🎷" name="Saxofon" >}}
{{< about-passion-pill icon="🎸" name="Chitară" >}}
{{< about-passion-pill icon="🍳" name="Gătit" >}}
{{< about-passion-pill icon="♟️" name="Șah" >}}
{{< /about-passion-grid >}}
