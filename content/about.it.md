---
title: "Chi sono"
seoTitle: "Ivan Luminaria: DBA Oracle, PostgreSQL e DWH Architect"
description: "Ivan Luminaria: 30 anni di esperienza come DBA Oracle, PostgreSQL e DWH Architect. Specialista in performance tuning, alta disponibilità e sicurezza database."
date: "2026-02-20"
lastmod: "2026-02-26"
draft: false
layout: "about"
...
{{< about-section-card icon="🔧" title="Come lavoro" >}}
...
{{< about-section-card icon="🎯" title="Visione" >}}
...
{{< about-section-card icon="🎨" title="Fuori dal database" >}}
...
{{< about-passion-grid >}}
{{< about-passion-pill icon="📷" name="Fotografia" >}}
{{< about-passion-pill icon="🎷" name="Sassofono" >}}
{{< about-passion-pill icon="🎸" name="Chitarra" >}}
{{< about-passion-pill icon="🍳" name="Cucina" >}}
{{< about-passion-pill icon="♟️" name="Scacchi" >}}
{{< /about-passion-grid >}}
