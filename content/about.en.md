...
description: "Ivan Luminaria, Technical Leader for mission-critical databases and Data Warehouses: 30 years across Oracle, PostgreSQL, MySQL alongside CIOs and CTOs."
date: "2026-02-20"
lastmod: "2026-09-14"
draft: false
layout: "about"
...
<div class="about-profile-card">
  ...
  <div class="about-profile-info">
    ...
    <p class="about-profile-role">Technical Leader for mission-critical databases and Data Warehouses</p>
...
{{< about-section-card icon="🔧" title="How I Work" >}}
...
{{< about-section-card icon="🎯" title="Vision" >}}
...
{{< about-section-card icon="🎨" title="Beyond the Database" >}}
...
{{< about-passion-grid >}}
{{< about-passion-pill icon="📷" name="Photography" >}}
{{< about-passion-pill icon="🎷" name="Saxophone" >}}
{{< about-passion-pill icon="🎸" name="Guitar" >}}
{{< about-passion-pill icon="🍳" name="Cooking" >}}
{{< about-passion-pill icon="♟️" name="Chess" >}}
{{< /about-passion-grid >}}
